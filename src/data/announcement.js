...
export const announcement = {
  ...
  winPaths: [
    ...
    { name: 'Jason',   can: false, bestFinish: 3,
      path:  'Can still reach 3rd — France plays in the 3rd place match (3× multiplier). Scenario: Argentina beats England in the SF, France wins 3rd, Argentina wins the Final with Spain scoring 0 goals.',
      path2: 'Les Bleus went quietly, 0–2 to Spain. But France earns 3× points in the 3rd place match. A strong France win (3-0) brings Jason to ~160pts. The obstacle is Jay — he holds Spain, so every Spain goal in the Final earns Jay points too. Spain stays scoreless and Argentina runs away: podium opens up.' },
