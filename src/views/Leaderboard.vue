          ...
          <div class="lb-center">
            <div class="lb-name-row">
              ...
              <div class="lb-badges">
                ...
                <span v-if="mostDraws.holders.has(entry.name)" class="lb-most-draws lb-tooltip-wrap" tabindex="0">🌊 Wash Mstr<span class="lb-tooltip">Most draws across all teams ({{ mostDraws.count }})</span></span>
