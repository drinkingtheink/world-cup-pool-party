          ...
          <div class="lb-center">
            <div class="lb-name-row">
              ...
              <div class="lb-badges">
                ...
                <span v-if="herdMentality.holders.has(entry.name)" class="lb-herd lb-tooltip-wrap" tabindex="0">🍍 Swingers<span class="lb-tooltip">Most teams shared with other players in the pool</span></span>
                ...
                <span v-if="iMeanCmon.holders.has(entry.name)" class="lb-i-mean-cmon lb-tooltip-wrap" tabindex="0">🙄 C'mon Man<span class="lb-tooltip">Top 3 highest-ranked pools by avg FIFA ranking</span></span>
